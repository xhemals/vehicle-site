...
export default function UIMileageNotFound() {
	return (
		<div className="flex flex-col items-center gap-1 h-full text-destructive">
			...
			<p className="text-center md:text-xl text-base">
				The vehicle needs a recorded MOT to know the mileage. There could be a
				number of reasons why a vehicle does not have a recorded MOT.
			</p>
			<p className="text-center md:text-xl text-base">
